...
class CLASS(O_TeamLeader_F): CLASS(O_Rifleman_F) {
	...
	linkedItems[] = {"CUP_V_O_SLA_M23_1_OD", "CUP_H_RUS_Balaclava_Ratnik_Headphones_v2", "G_Shades_Blue", "ItemMap", "ItemCompass", "ItemWatch", "ItemRadio"};
	respawnLinkedItems[] = {"CUP_V_O_SLA_M23_1_OD", "CUP_H_RUS_Balaclava_Ratnik_Headphones_v2", "G_Shades_Blue", "ItemMap", "ItemCompass", "ItemWatch", "ItemRadio"};
...
class CLASS(O_Rifleman_AT_F): CLASS(O_Rifleman_F) {
	...
	linkedItems[] = {"CUP_V_O_SLA_M23_1_OD", "CUP_H_RUS_Balaclava_Ratnik_Headphones", "G_Shades_Blue", "ItemMap", "ItemCompass", "ItemWatch", "ItemRadio"};
	respawnLinkedItems[] = {"CUP_V_O_SLA_M23_1_OD", "CUP_H_RUS_Balaclava_Ratnik_Headphones", "G_Shades_Blue", "ItemMap", "ItemCompass", "ItemWatch", "ItemRadio"};
	uniformClass = "milgp_u_g3_field_set_tropentarn_mcalpine";
...
class CLASS(O_Sapper_Sab_F): CLASS(O_Rifleman_F) {
	...
	linkedItems[] = {"V_SmershVest_01_radio_F", "CUP_H_RUS_Balaclava_Ratnik_Headphones_winter", "G_Shades_Blue", "ItemMap", "ItemCompass", "ItemWatch", "ItemRadio"};
	respawnLinkedItems[] = {"V_SmershVest_01_radio_F", "CUP_H_RUS_Balaclava_Ratnik_Headphones_winter", "G_Shades_Blue", "ItemMap", "ItemCompass", "ItemWatch", "ItemRadio"};
